angular
	.module('relQuartosModule',[])
	.controller('relQuartosControl', function($scope){
		...
		$scope.quartos = [
			{codigo:101, nome:'Suite Standard 01', descricao:'Quarto luxo para caal', imagem: 'img/suiteStandard.jpg', status: 'Ocupado', hospede: 'CARLOS EDUARDO DANTAS', cpf:'534.454.834-51', dataCheckin:'30/07/2015', dataCheckout:'02/08/2015', valorHospedagem:879.45, valorDespesas:98.3, observacao: ""},
			{codigo:102, nome:'Suite Standard 02', descricao:'Quarto luxo para caal', imagem: 'img/suiteStandard.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:764.34, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			...
			{codigo:104, nome:'Suite Standard 04', descricao:'Quarto luxo para caal', imagem: 'img/suiteStandard.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:843.34, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			...
			{codigo:203, nome:'Suite High Lux 03', descricao:'Quarto luxo para caal', imagem: 'img/suiteHighLux.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:823.43, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			{codigo:204, nome:'Suite High Lux 04', descricao:'Quarto luxo para caal', imagem: 'img/suiteHighLux.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:983.34, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			...
			{codigo:302, nome:'Duplex Premmium 02', descricao:'Quarto luxo para caal', imagem: 'img/suitePremmium.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:934.32, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			{codigo:303, nome:'Duplex Premmium 03', descricao:'Quarto luxo para caal', imagem: 'img/suitePremmium.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:934.32, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
			{codigo:304, nome:'Duplex Premmium 01', descricao:'Quarto luxo para caal', imagem: 'img/suitePremmium.jpg', status: 'Livre', hospede: '', cpf:'', dataCheckin:'', dataCheckout:'', valorHospedagem:2344.34, valorDespesas:0, observacao: "As caracteristicas incluem uma tranquila area de estar, colchoes de penas de luxo de qualidade."},
		];
