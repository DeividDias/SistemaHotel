...
public class ClienteFacade {
	...
	public List<Cliente> getCliente(@PathParam("codigoCliente") Integer codigo, @PathParam("nomeCliente") String nome){
	...
	@GET
	public List<Cliente> getClientes(Integer codigo, String nome){
		Cliente cliente = new Cliente();
		cliente.setCodigo(codigo);
		cliente.setNome(nome);
